  ...
  useEffect(() => {
    fetchPortalSession()
      .then((session) => {
        ...
        if (value.includes("FAC002") || value.includes("FOT_OFFICE") || value.includes("FOT")) return "/faculty/FOT_Office";
        if (value.includes("FAC003") || value.includes("FBSF_OFFICE") || value.includes("FBSF")) return "/faculty/FBSF_Office";
        return "/faculty/FAS_Office";
      })
